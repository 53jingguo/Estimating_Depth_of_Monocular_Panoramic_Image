...
def read_lut(size):
    ...
    LUT_mid_name = r'G:\***\LUT\LUT'+str(size)+'\LUT_mid.mat'
    ...
    LUT_left_name = r'G:\***\LUT\LUT'+str(size)+'\LUT_left.mat'
    ...
    LUT_right_name = r'G:\***\LUT\LUT'+str(size)+'\LUT_right.mat'
    ...
    LUT_up_name = r'G:\**\LUT\LUT' + str(size) + '\LUT_up.mat'
    ...
    LUT_down_name = r'G:\*\LUT\LUT' + str(size) + '\LUT_down.mat'
    ...
    LUT_left_up_name = r'G:\*\LUT\LUT' + str(size) + '\LUT_left_up.mat'
    ...
    LUT_left_down_name = r'G:\*\LUT\LUT' + str(size) + '\LUT_left_down.mat'
    ...
    LUT_right_up_name = r'G:\*\LUT\LUT' + str(size) + '\LUT_right_up.mat'
    ...
    LUT_right_down_name = r'G:\*\LUT\LUT' + str(size) + '\LUT_right_down.mat'
